...
container-train:
        ...
        @docker exec -it $(CONTAINER_NAME) python3 Diehl\&Cook_spiking_MNIST_Brian2.py --train --data-dir /app/mnist
        @echo "$(GREEN)Training completed$(NC)"

container-test:
        @echo "$(BLUE)Starting testing inside container...$(NC)"
        @docker exec -it $(CONTAINER_NAME) python3 Diehl\&Cook_spiking_MNIST_Brian2.py --test --data-dir /app/mnist
...
container-train-verbose:
        ...
        @docker exec -it $(CONTAINER_NAME) python3 Diehl\&Cook_spiking_MNIST_Brian2.py --train --verbose --data-dir /app/mnist
        @echo "$(GREEN)Training completed$(NC)"

container-test-verbose:
        @echo "$(BLUE)Starting testing inside container with verbose output...$(NC)"
        @docker exec -it $(CONTAINER_NAME) python3 Diehl\&Cook_spiking_MNIST_Brian2.py --test --verbose --data-dir /app/mnist
        @echo "$(GREEN)Testing completed$(NC)"
