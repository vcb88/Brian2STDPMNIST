...
nu_ee_pre =  0.0002      # pre-synaptic learning rate (increased from 0.0001 for balanced learning)
nu_ee_post = 0.01       # post-synaptic learning rate (1:50 ratio with pre-synaptic)
wmax_ee = 1.0
exp_ee_pre = 0.2
